...
public class SimonSays extends KeyAdapter {
	...
	public void run() {
		...
		JOptionPane.showMessageDialog(null, "Press the matching key when 'Simon says', otheriwse press a differnt key");
...
if(e.getKeyCode() == imageIndex && simonSays) {
	...
	if(tries>=10) {
		JOptionPane.showMessageDialog(null, "You got "+score+"/10!");
		frame.dispose();
		System.exit(0);
	}
}
